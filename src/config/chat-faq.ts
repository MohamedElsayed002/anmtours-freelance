...
export const FREQUENT_QUESTIONS: { question: string; answer: string }[] = [
  {
    question: "Who am I?",
    answer:
      "You are chatting with the A&T Tours Travel Assistant. I'm here to help you discover the perfect experiences in Sharm El Sheikh—whether you're looking for adventure, relaxation, family fun, or romantic getaways. Ask me anything about our tours!",
  },
  {
    question: "Who is A&T Tours?",
    answer:
      "A&T Tours is a premium travel agency in Sharm El Sheikh, Egypt. We offer curated experiences including safaris, diving, snorkeling, desert trips, and cultural tours. Contact us at info@amtours.com or +20 123 456 7890.",
  },
  {
    question: "What does A&T Tours offer?",
    answer:
  ...
  {
    question: "How can I contact A&T Tours?",
    answer:
